...
<body>
  ...
  <header id="header" class="header">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        <h1><a href="{{url('/')}}"><span>Syndo</span>Flora</a></h1>
        <!-- Uncomment below if you prefer tue an image logo -->
...
<!-- end barang-->
  ...
  <footer class="footer" id="footer">
        ...
        <div class="col-md-12 col-lg-4">
          <div class="footer-logo">
            ...
            <div class="life-unstyled">
                    <i class="fa fa-map-marker" style="color: white;font-size: 20px;"> kp pondok bitung desa sukaharja<br>Bogor, Indonesia</i>
                    <br><br>
                  <i class="fa fa-envelope" style="color: white;font-size: 20px;"> arrvella@gmail.com</i>
                <br><br>
                  <i class="fa fa-phone" style="color: white;font-size: 20px;"> +62 895-3499-99980</i>
                <br><br><br>
    ...
    <div class="copyrights">
      <div class="container">
        <p>Copyrights By @anonyarras.&copy; Syndo Flora 2021.</p>
        <div class="credits">
          <!--
        ...
        -->
          Designed by <a href="#">Bitung Mas</a>
        </div>
      </div>
    </div>
